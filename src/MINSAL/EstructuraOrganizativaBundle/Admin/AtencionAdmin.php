...
namespace MINSAL\EstructuraOrganizativaBundle\Admin;
...
class AtencionAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('tipoAtencion', null, array('label'=> $this->getTranslator()->trans('_tipo_atencion_')))
        ;
    }
