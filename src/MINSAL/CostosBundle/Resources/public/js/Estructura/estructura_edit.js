$(document).ready(function () {
    var id = $('select[id$="_parent"]').attr('id').split('_')[0];
    padre = $('select[id$="_parent"]').val();
    
    $('#s2id_'+id+'_parent').hide();
    $('#s2id_'+id+'_parent').after("<div id='jqxTree'></div>");
